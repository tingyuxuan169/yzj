...
import com.yqrj.common.annotation.DataFilter;
...
import com.yqrj.common.interceptor.DataScope;
...
public class DataFilterAspect {
    ...
    @Pointcut("@annotation(com.yqrj.common.annotation.DataFilter)")
    ...
    public void dataFilter(JoinPoint point) {
        ...
        throw new YqrjException(ErrorCode.DATA_SCOPE_PARAMS_ERROR);
    }
