...
public class YqrjExceptionHandler {
	private static final Logger logger = LoggerFactory.getLogger(YqrjExceptionHandler.class);
	 ...
	 * 处理自定义异常
	 */
	@ExceptionHandler(YqrjException.class)
	public Result handleRenException(YqrjException ex){
